import{bk as Hn,bl as l,bm as Wn,b6 as jt,bn as qn,bo as $,bp as X,bq as Q,b8 as _,br as Gt,bs as jn,bd as Gn,bt as zt,a$ as ae,bu as zn,bv as Kn,bj as Ke,b9 as Tt,bw as Et,a_ as yt,bx as Be,by as Bn,bz as y,bA as $n,bB as Yn,bC as Jn,bD as Xn}from"./index-857fbb56.js";function $e(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,i=Object.getOwnPropertySymbols(n);r<i.length;r++)e.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(n,i[r])&&(t[i[r]]=n[i[r]]);return t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function io(n,e){const t=l(n);await be(!0,t,e);const{providerUserInfo:i}=await ui(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=In(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function tt(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return w._forOperation(n,"link",i)}async function be(n,e,t){await ne(e);const i=In(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ro(n,e){if(_(n.app))return Promise.reject(v(n));const t=m(n),i=await rr(t,{token:e,returnSecureToken:!0}),r=await w._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function st(n){const e=m(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function so(n,e,t){const i=m(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Ne(i,r,t),await ie(i,r,"getOobCode",Wi)}async function oo(n,e,t){await mn(l(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&st(n),i})}async function ao(n,e){await Vi(l(n),{oobCode:e})}async function sr(n,e){const t=l(n),i=await mn(t,{oobCode:e}),r=i.requestType;switch(u(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":u(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":u(i.mfaInfo,t,"internal-error");default:u(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=he._fromServerResponse(m(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function co(n,e){const{data:t}=await sr(l(n),e);return t.email}async function uo(n,e,t){if(_(n.app))return Promise.reject(v(n));const i=m(n),o=await ie(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",gn).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&st(n),c}),a=await w._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function lo(n,e,t){return _(n.app)?Promise.reject(v(n)):nt(l(n),q.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&st(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ho(n,e,t){const i=m(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){u(a.handleCodeInApp,i,"argument-error"),a&&Ne(i,o,a)}s(r,t),await ie(i,r,"getOobCode",qi)}function fo(n,e){const t=le.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function po(n,e,t){if(_(n.app))return Promise.reject(v(n));const i=l(n),r=q.credentialWithLink(e,t||te());return u(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),nt(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mo(n,e){const t=Xe()?te():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await or(l(n),i);return r||[]}async function go(n,e){const t=l(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Ne(t.auth,r,e);const{email:s}=await Hi(t.auth,r);s!==n.email&&await n.reload()}async function _o(n,e,t){const i=l(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Ne(i.auth,s,t);const{email:o}=await ji(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Io(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const i=l(n),s={idToken:await i.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await O(i,ar(i.auth,s));i.displayName=o.displayName||null,i.photoURL=o.photoUrl||null;const a=i.providerData.find(({providerId:c})=>c==="password");a&&(a.displayName=i.displayName,a.photoURL=i.photoURL),await i._updateTokensIfNecessary(o)}function vo(n,e){const t=l(n);return _(t.auth.app)?Promise.reject(v(t.auth)):En(t,e,null)}function To(n,e){return En(l(n),null,e)}async function En(n,e,t){const{auth:i}=n,s={idToken:await n.getIdToken(),returnSecureToken:!0};e&&(s.email=e),t&&(s.password=t);const o=await O(n,Mi(i,s));await n._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cr(n){var e,t;if(!n)return null;const{providerId:i}=n,r=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},s=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&(n!=null&&n.idToken)){const o=(t=(e=ke(n.idToken))===null||e===void 0?void 0:e.firebase)===null||t===void 0?void 0:t.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new K(s,a)}}if(!i)return null;switch(i){case"facebook.com":return new ur(s,r);case"github.com":return new dr(s,r);case"google.com":return new lr(s,r);case"twitter.com":return new hr(s,r,n.screenName||null);case"custom":case"anonymous":return new K(s,null);default:return new K(s,i,r)}}class K{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class yn extends K{constructor(e,t,i,r){super(e,t,i),this.username=r}}class ur extends K{constructor(e,t){super(e,"facebook.com",t)}}class dr extends yn{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class lr extends K{constructor(e,t){super(e,"google.com",t)}}class hr extends yn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Eo(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:cr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yo(n,e){return l(n).setPersistence(e)}function wo(n){return Ni(n)}async function Ao(n,e){return m(n).validatePassword(e)}function fr(n,e,t,i){return l(n).onIdTokenChanged(e,t,i)}function pr(n,e,t){return l(n).beforeAuthStateChanged(e,t)}function Ro(n,e,t,i){return l(n).onAuthStateChanged(e,t,i)}function So(n){l(n).useDeviceLanguage()}function ko(n,e){return l(n).updateCurrentUser(e)}function Po(n){return l(n).signOut()}function bo(n,e){return m(n).revokeAccessToken(e)}async function No(n){return l(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(n,e,t){return is(n,e,t)}async function is(n,e,t){if(_(n.app))return Promise.reject(v(n));const i=m(n);Y(n,e,D),await i._initializationPromise;const r=j(i,t);return await lt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function qo(n,e,t){return rs(n,e,t)}async function rs(n,e,t){const i=l(n);if(Y(i.auth,e,D),_(i.auth.app))return Promise.reject(v(i.auth));await i.auth._initializationPromise;const r=j(i.auth,t);await lt(r,i.auth);const s=await Un(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function jo(n,e,t){return ss(n,e,t)}async function ss(n,e,t){const i=l(n);Y(i.auth,e,D),await i.auth._initializationPromise;const r=j(i.auth,t);await be(!1,i,e.providerId),await lt(r,i.auth);const s=await Un(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function Go(n,e){return await m(n)._initializationPromise,Dn(n,e,!1)}async function Dn(n,e,t=!1){if(_(n.app))return Promise.reject(v(n));const i=m(n),r=j(i,e),o=await new es(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Un(n){const e=Ce(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qs=5*60,js=Gt("authIdTokenMaxAge")||qs;let qt=null;const Gs=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>js)return;const r=t==null?void 0:t.token;qt!==r&&(qt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function zo(n=Gn()){const e=jt(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Oi(n,{popupRedirectResolver:Ms,persistence:[Dr,yr,Sn]}),i=Gt("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=Gs(s.toString());pr(t,o,()=>o(t.currentUser)),fr(t,a=>o(a))}}const r=jn("auth");return r&&Li(t,`http://${r}`),t}function zs(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}Ai({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=T("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",zs().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ws("Browser");export{Xs as ActionCodeOperation,le as ActionCodeURL,de as AuthCredential,Zs as AuthErrorCodes,re as EmailAuthCredential,q as EmailAuthProvider,M as FacebookAuthProvider,Bs as FactorId,V as GithubAuthProvider,F as GoogleAuthProvider,C as OAuthCredential,Te as OAuthProvider,Js as OperationType,W as PhoneAuthCredential,B as PhoneAuthProvider,Fs as PhoneMultiFactorGenerator,$s as ProviderId,Lo as RecaptchaVerifier,Ge as SAMLAuthProvider,Ys as SignInMethod,Vs as TotpMultiFactorGenerator,ft as TotpSecret,x as TwitterAuthProvider,ao as applyActionCode,pr as beforeAuthStateChanged,yr as browserLocalPersistence,Ms as browserPopupRedirectResolver,Sn as browserSessionPersistence,sr as checkActionCode,oo as confirmPasswordReset,Li as connectAuthEmulator,uo as createUserWithEmailAndPassword,Qs as debugErrorMap,No as deleteUser,mo as fetchSignInMethodsForEmail,Eo as getAdditionalUserInfo,zo as getAuth,eo as getIdToken,di as getIdTokenResult,Oo as getMultiFactorResolver,Go as getRedirectResult,Pt as inMemoryPersistence,Dr as indexedDBLocalPersistence,Oi as initializeAuth,wo as initializeRecaptchaConfig,fo as isSignInWithEmailLink,nr as linkWithCredential,Uo as linkWithPhoneNumber,Ho as linkWithPopup,jo as linkWithRedirect,Co as multiFactor,Ro as onAuthStateChanged,fr as onIdTokenChanged,to as parseActionCodeURL,Zn as prodErrorMap,ir as reauthenticateWithCredential,Mo as reauthenticateWithPhoneNumber,xo as reauthenticateWithPopup,qo as reauthenticateWithRedirect,fi as reload,bo as revokeAccessToken,go as sendEmailVerification,so as sendPasswordResetEmail,ho as sendSignInLinkToEmail,yo as setPersistence,no as signInAnonymously,nt as signInWithCredential,ro as signInWithCustomToken,lo as signInWithEmailAndPassword,po as signInWithEmailLink,Do as signInWithPhoneNumber,Vo as signInWithPopup,Wo as signInWithRedirect,Po as signOut,io as unlink,ko as updateCurrentUser,vo as updateEmail,To as updatePassword,Fo as updatePhoneNumber,Io as updateProfile,So as useDeviceLanguage,Ao as validatePassword,_o as verifyBeforeUpdateEmail,co as verifyPasswordResetCode};
//# sourceMappingURL=index.esm-15ccca25.js.map
